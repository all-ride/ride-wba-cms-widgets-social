...
use ride\web\cms\controller\widget\component\SocialMediaComponent;
 ...
 */
class SocialMediaLinkWidget extends AbstractWidget implements StyleWidget{
    ...
    public function getPropertiesPreview() {
        ...
        if ($values) {
            foreach ($values as $value) {
                $preview .= "<strong>" . $value['socialMediaName'] . "</strong>: " . $value['accountName'] . "<br />";
            }
        }
